...
st.markdown("<h3 style='text-align: center;color:black;'>Please input the feature values to predict the best crop to plant.</h3><br>", unsafe_allow_html=True)
...
with col5:
    ...
    location = st.selectbox('Select location:',('Central India', 'Eastern India', 'North Eastern India', 'Northern India', 'Western India', 'Southern India'))
...
if predict_btn:
    ...
    with colb:
        ...
        with col1:
            ...
            st.markdown(f"<br><h5 style='text-align: right;color:black;'>Best Crop to Plant </h5> <h3 style='text-align: right; line-height: 0'> <b>{rdf_predicted_value[0]} </b></h3>", unsafe_allow_html=True)
        ...
        st.markdown(f"""<h5 style='text-align: center;color:black;'>Statistics Summary about NPK and Weather Conditions values for <b> {rdf_predicted_value[0]} 
